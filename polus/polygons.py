...
class PyPolygonSet:
    ...
    def __init__(self, connectivity: int):
        ...
        self.__polygon_set: ftl_labelling.PolygonSet = ftl_labelling.PolygonSet(connectivity)
            ...
            for z in range(writer.Z):
                for y in range(0, writer.Y, tile_size):
                    ...
                    for x in range(0, writer.X, tile_size):
                        ...
                        tile = ftl_labelling.extract_tile(self.__polygon_set, (z, z + 1, y, y_max, x, x_max))
